...
class FillPermissionsForDetailMemo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetailMemo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.detail-memo',
            'admin.detail-memo.index',
            'admin.detail-memo.create',
            'admin.detail-memo.show',
            'admin.detail-memo.edit',
            'admin.detail-memo.delete',
            'admin.detail-memo.bulk-delete',
        ]);
