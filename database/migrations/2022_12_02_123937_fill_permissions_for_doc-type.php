...
class FillPermissionsForDocType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDocType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.doc-type',
            'admin.doc-type.index',
            'admin.doc-type.create',
            'admin.doc-type.show',
            'admin.doc-type.edit',
            'admin.doc-type.delete',
            'admin.doc-type.bulk-delete',
        ]);
