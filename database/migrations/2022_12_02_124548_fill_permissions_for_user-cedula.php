...
class FillPermissionsForUserCedula extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserCedula constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-cedula',
            'admin.user-cedula.index',
            'admin.user-cedula.create',
            'admin.user-cedula.show',
            'admin.user-cedula.edit',
            'admin.user-cedula.delete',
            'admin.user-cedula.bulk-delete',
        ]);
