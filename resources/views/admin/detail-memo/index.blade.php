...
@section('title', trans('admin.detail-memo.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/detail-memos/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.detail-memo.actions.create') }}</a>
                    </div>
